        ...
        <div class="container">
            <div class="title-box">
                <h1>
                  <?php
                      if ( is_day() ) :
                          printf( esc_html__( 'Daily Archives: %s', 'consult' ), get_the_date() );

                      elseif ( is_month() ) :
                          printf( esc_html__( 'Monthly Archives: %s', 'consult' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'consult' ) ) );

                      elseif ( is_year() ) :
                          printf( esc_html__( 'Yearly Archives: %s', 'consult' ), get_the_date( _x( 'Y', 'yearly archives date format', 'consult' ) ) );

                      else :
                          esc_html_e( 'Archives', 'consult' );
                ...
                <ol class="breadcrumb">
                    ...
                    <li><?php echo esc_html__( 'Archive', 'consult' ); ?></li>
                </ol>
            </div>
        </div> <!-- end container -->
    </section>
