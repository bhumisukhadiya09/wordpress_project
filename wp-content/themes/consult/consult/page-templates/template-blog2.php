<?php
/*
 * Template Name: Template Blog Sidebar Right
                          ...
                          <div class="grid">
                              ...
                              <div class="entry-meta">
                                  <ul>
                                      ...
                                      <li><a href="#"><i class="fa fa-comments"></i> <span><?php comments_popup_link( esc_html__(' 0 comment', 'consult'), esc_html__(' 1 comments', 'consult'), ' % comments'.__('', 'consult')); ?></span> </a></li>
                                  </ul>
                              </div>
