<?php
/*
 * Template Name: Template Studies Style 2
...
<!-- end page-title -->
<!-- start case-studies-s2  -->
        <section class="case-studies-s2-content-wrapper section-padding">
            <div class="container">
                <div class="row">
                    <div class="col col-lg-9 col-lg-push-3 col-md-push-4 col-md-8 case-studies-s2-content">
                <?php 
                    $args = array(   
                                'post_type' => 'studies',   
                                'paged' => $paged, 
                ...
                <div class="row">
                    ...
                    <div class="col col-lg-7 col-sm-6">
                        <div class="details">
                            ...
                            <div class="read-more">
                            <a href="<?php the_permalink();?>" class="btn"><?php if(isset($consult_redux_demo['read_more'])){?>
