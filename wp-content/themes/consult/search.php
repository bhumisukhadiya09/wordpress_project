<?php
$consult_redux_demo = get_option('consult_redux_demo');
get_header(); ?>
<!-- start page-title -->
    <section class="page-title">
        <div class="container">
            <div class="title-box">
                <h1>
                  <?php echo esc_html__( 'Search Result :', 'consult' ); ?>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo esc_url(home_url('/')); ?>"><?php echo esc_html__( 'Home', 'consult' ); ?></a></li>
                    <li><?php echo esc_html__( 'Search', 'consult' ); ?></li>
                </ol>
            </div>
        </div> <!-- end container -->
    </section>
                  ...
                  <?php 
                    ...
                    ?>  
                      ...
                      <?php endwhile; else :?> 
                                ...
                                '<p>'. esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'consult' ).'</p>';?></h4>
